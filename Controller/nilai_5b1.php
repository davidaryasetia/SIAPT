...
if ($rata_prestasi_internasional >= $a){
    ...
    $skor_5b1 = 3 + ($rata_prestasi_provinsi/$a);
} else if ($rata_prestasi_internasional < $a && $rata_prestasi_nasional < $b){
    $skor_5b1 = 2 + (2 * ($rata_prestasi_internasional/$a)) + ($rata_prestasi_nasional/$b) - (($rata_prestasi_internasional * $rata_prestasi_nasional) / ($a * $b));
} else if ($rata_prestasi_internasional == 0 && $rata_prestasi_nasional == 0 && $rata_prestasi_provinsi >= $c){
    $skor_5b1 = 2;
} else if ($rata_prestasi_internasional == 0 && $rata_prestasi_nasional == 0 && $rata_prestasi_provinsi < $c){
    $skor_5b1 = 1 + ($rata_prestasi_provinsi/$c);
} else {
    $skor_5b1 < 0;
}
...
// Keterangan Skor
if($skor_5b1 == 4){
    $keterangan = '<span style="color:green;font-weight:bold">Skor Tabel 5.b.1 Prestasi Akademik Mahasiswa memenuhi target maksimum</span>';
} else if ($skor_5b1 < 4 && $skor_5b1 >0){
    $keterangan = '<span style="color:orange;font-weight:bold">Skor Tabel 5.b.1 Prestasi Akademik Mahasiswa belum memenuhi target maksimal !!</span>';
} else {
    $keterangan = '<span style="color:red; font-weight:bold">Skor Tabel 5.b.1 Prestasi Akademik Mahasiswa 0 !!</span>';
}
?>

<!-- Simulasi Skoor Javascript 5.b.1 -->
<script>
    ...
    document.addEventListener("DOMContentLoaded", function () {
        ...
        function hitung_simulasi() {
            ...
            // Hitung Simulasi Skoor Tabel 5.b.1
            if (rata_prestasi_Internasional >= a) {
                simulasi_skor_5b1 = 4;
            } else if (rata_prestasi_Internasional < a && rata_prestasi_Nasional >= b) {
                simulasi_skor_5b1 = 3 + (rata_prestasi_Internasional / a);
            } else if (rata_prestasi_Internasional < a && rata_prestasi_Nasional < b) {
                simulasi_skor_5b1 = 2 + (2 * (rata_prestasi_Internasional / a)) + (rata_prestasi_Nasional / b) -
                ...
                rata_prestasi_Provinsi < c) {
                simulasi_skor_5b1 = 1 + (rata_prestasi_Provinsi / c);
            } else {
                simulasi_skor_5b1 < 1
            }

            // Keterangan
            if (simulasi_skor_5b1 == 4) {
                nilai_simulasi_keterangan =
                    '<span style="color:green;font-weight:bold">Simulasi Skoor Tabel 5.b.1 Prestasi Akademik Mahasiswa Mencapai Hasil Maksimal (4)</span>';
            } else if (simulasi_skor_5b1 < 4 && simulasi_skor_5b1 > 0) {
                nilai_simulasi_keterangan =
                    '<span style="color:orange; font-weight: bold">Simulasi Skoor Tabel 5.b.1 Prestasi Akademik Mahasiswa Belum Mencapai Hasil Maksimal !!</span>';
            } else {
                nilai_simulasi_keterangan =
                    '<span style="color:red;font-weight:bold">Simulasi Skoor Tabel 5.b.1 Prestasi Akademik 0 !!</span>';
            }
            ...
            skor.textContent = simulasi_skor_5b1;
