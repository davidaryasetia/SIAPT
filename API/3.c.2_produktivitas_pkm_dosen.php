...
PENELITIAN.JENIS='pengabdian'
PENELITIAN.TAHUN_USULAN TS-2(2019), TS-1(2020), TS(2020)
*/
$query='SELECT 1 AS "Nomor", \'Perguruan tinggi atau mandiri\' AS "Sumber Pembiayaan", 
COUNT(DISTINCT CASE WHEN PENELITIAN.TAHUN_USULAN=2017 THEN PENELITIAN.ID END) AS "TS-2(2017)", 
COUNT(DISTINCT CASE WHEN PENELITIAN.TAHUN_USULAN=2018 THEN PENELITIAN.ID END) AS "TS-1(2018)", 
COUNT(DISTINCT CASE WHEN PENELITIAN.TAHUN_USULAN=2019 THEN PENELITIAN.ID END) AS "TS(2019)"
FROM PENELITIAN
...
WHERE PENELITIAN.JENIS=\'pengabdian\' 
