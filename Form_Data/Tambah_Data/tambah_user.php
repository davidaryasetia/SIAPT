                                                ...
                                                <div class="card-body">
                                                    <form class="forms-sample" method="POST" action=""
                                                        ...
                                                        <div class="form-row">
                                                            ...
                                                            <div class="form-group col-md-6">
                                                                <label for="bidang">NIP</label>
                                                                <input type="nomor" class="form-control text-dark"
                                                                    id="bidang_keahlian" name="nip"
                                                        ...
                                                        <div class="form-row">
                                                            <div class="form-group col-md-6">
                                                                ...
                                                                <select class="form-control text-dark" id=""
                                                                    ...
                                                                    <option value="Tim Akreditasi">Tim Akreditasi
                                                                    </option>
                                                                    <option value="Kaprodi">Kaprodi</option>
                                                                    <option value="Wadir">Wadir</option>
                                                                    <option value="Reviewer Internal">Reviewer Internal
                                                                    </option>
                                                                </select>
                                                            </div>
                                                            <div class="form-group col-md-6">
                                                        ...
                                                        <div class="form-row">
                                                            <div class="form-group col-md-6">
                                                                ...
                                                                <input type="number" class="form-control text-dark"
                                                                    id="exampleInput" name="no_telepon"
