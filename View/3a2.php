                                ...
                                <div class="card-body">
                                    <div class="d-flex justify-content-start align-items-center">
                                        <p class="card-title mr-3"><a href="daftar_tabel.php"><i
                                            ...
                                            3.a.2 Jabatan Akademik Dosen Tetap </p>
                                                                    ...
                                                                    <ul>
                                                                        <li><span class="font_weight">
                                                                            ...
                                                                            <span style="display:block">
                                                                                ( Jumlah dosen tetap Jabatan Lektor
                                                                                Kepala atau Guru Besar / Jumlah dosen
                                                                                tetap
                                                                                ) x 100%
                                                                            </span>
                                                                        </li>
                                                                        <hr>
                                                                        <li><span class="font_weight">
                                                                                Skor Tabel 3.a.2 LKPT
                                                                                Jabatan Fungsional
                                                                                Dosen:</span>
                                                                            <span style="display:block;">
                                                                                <ul>
                                                                                    <li>
                                                                                        Jika Presentase >= 25% : skor
                                                                                        (4)
                                                                                    </li>
                                                                                    <li>
                                                                                        Jika Presentase < 25% : skor (1
                                                                                            + (12 x Presentase)) </li>
                                                                                            <li>
