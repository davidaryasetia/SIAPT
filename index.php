    ...
    <main class="flex-shrink-0">
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-white py-3">
            <div class="container px-5">
                <a class="navbar-brand" href="index.html"><span class="fw-bolder fs-2 text-primary">SIAPT</span></a>
                ...
                <div class="row gx-5 align-items-center">
                    <div class="col-xxl-5">
                        ...
                        <div class="text-center text-xxl-start">
                            <div class="fs-3 fw-light text-muted">Halo Selamat Datang!</div>
                            <h3 class="display-3 fw-bolder mb-2"><span class="text-primary d-inline">Apa itu
                                    SIAPT?</span></h3>
                            <div class="fs-5 fw-light text-dark mb-3">SIAPT adalah sebuah sistem informasi manajemen
                                akreditasi berbasis WEB, yang berguna untuk mengisi Laporan Kinerja Perguruan Tinggi,
                                dalam rangka menganalisa kebutuhan dan ketersediaan data yang mendukung laporan kinerja.
                            </div>
                            <div
                                class="d-grid gap-3 d-sm-flex justify-content-sm-center align-items-center justify-content-xxl-start mb-3">
                    ...
                    <div class="col-xxl-7">
                        ...
                        <div class="d-flex justify-content-center mt-5 mt-xxl-0">
                            <div class="profile bg-primary">
                                ...
                                <!-- <img class="profile-img w-75 h-75 mt-0" src="includes/contents/Image/PENS.png" -->
                                <!-- alt="..." /> -->
